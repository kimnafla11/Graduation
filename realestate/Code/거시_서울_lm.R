house = read.csv('Data/seoul3.csv')
house = house[,c(-1,-2)]
#######
...
plot(dmwr$V1,type='l',xlim=c(12,96), ylim=c(140000,1000000))
min(dmwr[12:96,])
which(dmwr<=139995) #optimal ws 20 mse=139994.5
...
r = house$평균아파트매매가격.서울.[21:104]-lmw[21:104]
plot(r, type = 'o')

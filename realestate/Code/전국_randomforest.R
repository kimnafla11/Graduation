...
for(i in 12:96){
  source("Code/Functions/DIFFRANDOMFOREST_FUNCTION.r")
  rmw=rmw(diff_house,i)
  rmw = na.omit(rmw)
  dmwr[i,]= mean((diff_house[i:109,17]-rmw)^2)
}
plot(dmwr$V1,type='l',xlim=c(12,96), ylim=c(800,2100))
min(dmwr[12:96,])
which(dmwr<=856) #optimal ws 20 mse=855.0521

source("Code/Functions/DIFFRANDOMFOREST_FUNCTION.r")
rmw = rmw(diff_house,20)
plot(diff_house[,17],type='l')
points(rmw,type ='l',col='red')
abline(v=20, col='blue')


r = diff_house$V17[21:109]-rmw[21:110]
write.csv(r,file = 'Output/Data/전국_rf_residual.csv')
plot(r, type = 'o')

...
for(i in 12:96){
  source("Code/Functions/DIFFRANDOMFOREST_FUNCTION.r")
  rmw=rmw(diff_kyeong,i)
  rmw = na.omit(rmw)
  dmwr[i,]= mean((diff_kyeong[i:109,17]-rmw)^2)
}
plot(dmwr$V1,type='l',xlim=c(12,96), ylim=c(300,1100))
min(dmwr[12:96,])
which(dmwr<=368) #optimal ws 20 mse=367.4766

source("Code/Functions/DIFFRANDOMFOREST_FUNCTION.r")
rmw = rmw(diff_kyeong,20)
plot(diff_kyeong[,17],type='l')
points(rmw,type ='l',col='red')
abline(v=20, col='blue')


r = diff_kyeong$V17[20:109]-rmw[20:110]
plot(r, type = 'o')
